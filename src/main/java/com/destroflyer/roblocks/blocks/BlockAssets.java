 ...
 */
package com.destroflyer.roblocks.blocks;
...
public class BlockAssets{
    ...
    public static BlockTerrainControl createNewBlockTerrain(Vector3Int chunksCount){
        return new BlockTerrainControl(getSettings(MainApplication.INSTANCE), chunksCount);
    }
    
    public static CubesSettings getSettings(MainApplication mainApplication){
        CubesSettings cubesSettings = new CubesSettings(mainApplication);
        cubesSettings.setBlockSize(Map.TILE_SIZE);
